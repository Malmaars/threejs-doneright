...
function Island(_camera ,scene, fontLoader, modelLoader, texLoader, engine, boatReference, location, billboardTexture, title, descriptions, link)
{
    ...
    const platform = new Platform(_camera ,scene, modelLoader, texLoader, new THREE.Vector3(location.x, location.y + 0.9, location.z - 8), boatReference, link);
    const tree = [
